...
function navbarColorOnResize() {
  const referenceButtons = document.getElementById('referenceButtons'); // Get the reference to the buttons
  const sidenav = document.getElementById('sidenav'); // Get the reference to the sidenav

  if (!referenceButtons || !sidenav) {
    console.warn("Reference buttons or sidenav not found in the DOM.");
    return;
  }
